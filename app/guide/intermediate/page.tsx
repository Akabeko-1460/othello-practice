...
export default function IntermediateGuidePage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
      <Link
        href="/guide"
        className="inline-flex items-center gap-1 text-accent text-sm hover:underline mb-4"
      >
      ...
      <div className="mt-10 p-5 bg-violet-50 rounded-2xl border border-violet-200">
        <h3 className="font-bold text-sm mb-2 flex items-center gap-2">
          <span className="w-6 h-6 rounded-md bg-violet-500 text-white flex items-center justify-center text-xs">
            !
          </span>
          実践のすすめ
        </h3>
        <p className="text-sm text-text-muted leading-relaxed">
          ...
          対戦モードの「1手評価モード」を使って、毎手フィードバックを受けながら上達しましょう。
